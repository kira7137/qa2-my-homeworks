...
public class TicketsStepDefs {
    ...
    @Then("price calculated is: {}") //v rabote s cenami ispolzuem bigdecimal kak bolee tochnij format
    //. - simvol, * - mnogo simvolov
    ...
    public void check_seat() {
        Assertions.assertEquals(given.getSeat(), seatsPage.getSeatNr(), "Wrong seat number");
    }
    ...
    public void check_success_msg() {
        Assertions.assertEquals("Thank You for flying with us!", successPage.getMessage(), "Cant find success msg");
    }
    ...
    public void check_reservation() {
        ...
        Assertions.assertNotNull(actual, "Cant find reservation");
        ...
        Assertions.assertEquals(given.getDiscount(), actual.getDiscount(), "Wrong discount");
        Assertions.assertEquals(given.getAdults(), actual.getAdults(), "Wrong passengers count");
        Assertions.assertEquals(given.getChildren(), actual.getChildren(), "Wrong children count");
        Assertions.assertEquals(given.getBugs(), actual.getBugs(), "Wrong luggage count");
    }
}
